...
error_reporting(0);
 ...
 $con=$dbi->connect();
      ...
      $p_R4=$dbi->getReg4List_graph($con);
	  $p_R6=$dbi->getReg6List_graph($con);
	  $p_R12=$dbi->getReg12List_graph($con);
	  $p_R24=$dbi->getReg24List_graph($con);
...
${demo.css}
       ...
       <input type="hidden" name="p_R4" class="p_R4" placeholder="Search..." value="<?php echo $p_R4; ?>" >		
       <input type="hidden" name="p_R6" class="p_R6" placeholder="Search..." value="<?php echo $p_R6; ?>" >
       <input type="hidden" name="p_R12" class="p_R12" placeholder="Search..." value="<?php echo $p_R12; ?>" >		
       <input type="hidden" name="p_R24" class="p_R24" placeholder="Search..." value="<?php echo $p_R24; ?>" >	
...
// Patients
	var p_R4= $(".p_R4").val();
	var pt_R4=parseInt(p_R4);
	var p_R6= $(".p_R6").val();
	var pt_R6=parseInt(p_R6);
	var p_R12= $(".p_R12").val();
	var pt_R12=parseInt(p_R12);
	var p_R24= $(".p_R24").val();
	var pt_R24=parseInt(p_R24);
	
	
    $('#container').highcharts({
        title: {
            text: 'Enrollment summary, 2016',
            x: -20 //center
        },
        subtitle: {
        ...
        xAxis: {
            categories: ['Week 4', 'Week 6', 'Week 12', 'Week 24']
        },
        yAxis: {
            title: {
                text: 'Total clients'
        ...
        series: [{
            name: 'Registration',
            data: [pt_R4, pt_R6,pt_R12,pt_R24]
        }]
    });
});
		</script>
