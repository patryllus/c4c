...
$nb_shwari=$dbi->sum_clients($con,25436);						
$mb_aar=$dbi->sum_clients($con,11194);
$is_77=$dbi->sum_clients($con,11917);
$nb_afya=$dbi->sum_clients($con,18344);
...
${demo.css}
       ...
       <input type="hidden" name="nb_shwari" class="nb_shwari" placeholder="Search..." value="<?php echo $nb_shwari; ?>" >		
       <input type="hidden" name="mb_aar" class="mb_aar" placeholder="Search..." value="<?php echo $mb_aar; ?>" >	
       <input type="hidden" name="is_77" class="is_77" placeholder="Search..." value="<?php echo $is_77; ?>" >
        <input type="hidden" name="nb_afya" class="nb_afya" placeholder="Search..." value="<?php echo $nb_afya; ?>" >												
		<script type="text/javascript">
$(function () {
    // Create the cha
	var nb_shwari= $(".nb_shwari").val();
	var clients_nb_shwari=parseInt(nb_shwari);
	var mb_aar= $(".mb_aar").val();
	var clients_mb_aar=parseInt(mb_aar);
	var is_77= $(".is_77").val();
	var clients_is_77=parseInt(is_77);
	var nb_afya= $(".nb_afya").val();
	var clients_nb_afya=parseInt(nb_afya);
	//alert (tfacilities);
	//alert (tfacilities);
    $('#container').highcharts({
        ...
        title: {
            text: 'Clients per Facility, 2016'
        },
        subtitle: {
        ...
        tooltip: {
         ...
         series: [{
            ...
            data: [{
                 ...
                 name:'Shwari Medical Clinic' ,
                y:clients_nb_shwari ,
                   
            }, {
                name: 'Mombasa AAR Medical Clinic',
                y: clients_mb_aar,
              
            }, {
                name: '78 Isiolo Medical Clinic',
                y: clients_is_77,
                
            }, {
                name: 'Afya House Dispensary',
                y: clients_nb_afya,
                    ...
                    <div class="row">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Clients per Facility</h3>
                            </div><!-- /.box-header -->
                            <div class="box-body">
<!--                                <input type="datetime" name="date_from" id="date_from" placeholder="Date  From" class="date_from "/>
						 ...
						 $p_rs=$dbi->getFacilityList($con);
    	                  while($p_row=mysql_fetch_array($p_rs)) {
													...
													$f_county=$dbi->getCounty($con,$mfl_no);
												    $f_type=$dbi->getFacilityType($con,$mfl_no);                                                  
                                                    $tclients=$dbi->sum_clients($con,$mfl_no);
									 ...
									 ?>				
                                        <tr>
                                            ...
                                            <td><?php print $mfl_no; ?></td>
                                             <td><?php print $tclients; ?></td>
                                            <td><?php print $f_type; ?></td> 
